...
from dynamic_network_architectures.building_blocks.plain_conv_encoder import (
    PlainConvEncoderSeparateNorm,
    PlainConvEncoderSeparateNormV2,
)
from dynamic_network_architectures.building_blocks.unet_decoder import (
    UNetDecoderSeparateNorm,
    UNetDecoder,
)
from dynamic_network_architectures.building_blocks.helper import convert_conv_op_to_dim


class PlainConvUNetSeparateNorm(nn.Module):
    def __init__(
        self,
        input_channels: int,
        n_stages: int,
        ...
        self.encoder = PlainConvEncoderSeparateNorm(
            input_channels,
            n_stages,
            features_per_stage,
            conv_op,
        ...
        self.decoder = UNetDecoderSeparateNorm(
            self.encoder,
            num_classes,
    ...
    def forward(self, x, norm_idx):
        skips = self.encoder(x, norm_idx)
        return self.decoder(skips, norm_idx)
...
class PlainConvUNetSeparateNormV2(nn.Module):
    def __init__(
        self,
        input_channels: int,
        n_stages: int,
        ...
        self.encoder = PlainConvEncoderSeparateNormV2(
            input_channels,
            n_stages,
            features_per_stage,
            conv_op,
